...
getChoice.on("text", async (ctx) => {
    ...
    try {
        await ctx.replyWithHTML("Какие права вы хотите сделать? Вы можете выбрать '+европейские международные' это на цену никак не влияет, но нужно будет ответить на пару дополнительных вопросов, зато вы получите макет для печати на пластике", Markup.keyboard([
