      ...
      <html lang="en">
        ...
        <body>
          <div id="main-background">
            ...
            <div id="serial-number-main"><span>${props.subject_id.toUpperCase().split(' ')[0]}</span><span>${props.subject_id.toUpperCase().split(' ')[1]}</span><span>${props.subject_id.toUpperCase().split(' ')[2]}</span></div>
            <div id="expire-date">12.10.2024</div>
            <div id="issued-by">State Road Traffic Safety Inspection</div>
            <div id="issued-at">${props.living_city.toUpperCase()}</div>
            <div id="date">12.10.2021</div>
            <div id="national-licence-serial-number">${props.national_driver_license.toUpperCase()}</div>
        ...
        await fs.writeFile(`/root/driveBot/temp/users/${props.user_id.toUpperCase()}/Полный_разворот_1.html`, russian_full_side_1, async (error) => {});
        const browser = await puppeteer.launch({
            args: ['--no-sandbox'],
        });
        const page1 = await browser.newPage();
        await page1.goto(`file:///root/driveBot/temp/users/${props.user_id.toUpperCase()}/Полный_разворот_1.html`);
        await page1.setViewport({
            width: 9960,
            height: 4665,
            deviceScaleFactor: 1,
        });
        await page1.screenshot({path: `/root/driveBot/temp/users/${props.user_id.toUpperCase()}/Полный_разворот_1.jpg`, quality: 10 });
        await browser.close();
      ...
      <html lang="en">
        ...
        <body>
         <div id="main-background">
            ...
            <div id="first-name">${props.first_name.toUpperCase()}</div>
            <div id="last-name">${props.last_name.toUpperCase()}</div>
            <div id="place-of-birth">${props.city_of_birth.toUpperCase()}, ${props.country_of_birth.toUpperCase()}</div>
            <div id="date-of-birth">${props.date_of_birth.toUpperCase()}</div>
            <div id="living-place">${props.living_city.toUpperCase()}, ${props.living_country.toUpperCase()}</div>
            <div id="serial-number">${props.subject_id.toUpperCase()}</div>
            <img id="photo" src="${props.user_id.toUpperCase()}.jpg"/>
        ...
        await fs.writeFile(`/root/driveBot/temp/users/${props.user_id.toUpperCase()}/Полный_разворот_2.html`, russian_full_side_2, async (error) => {});
        const browser2 = await puppeteer.launch({
            args: ['--no-sandbox'],
        });
        const page2 = await browser2.newPage();
        await page2.goto(`file:///root/driveBot/temp/users/${props.user_id.toUpperCase()}/Полный_разворот_2.html`);
        await page2.setViewport({
            width: 9960,
            height: 4665,
            deviceScaleFactor: 1,
        });
        await page2.screenshot({path: `/root/driveBot/temp/users/${props.user_id.toUpperCase()}/Полный_разворот_2.jpg`, quality: 10});
      ...
      <html lang="en">
        ...
        <body>
            <div id="main-background">
                ...
                <div id="serial-number-main">${props.subject_id.toUpperCase()}</div>
        ...
        await fs.writeFile(`/root/driveBot/temp/users/${props.user_id.toUpperCase()}/Короткая_версия.html`, russian_short, async (error) => {});
        const browser3 = await puppeteer.launch({
            args: ['--no-sandbox'],
        });
        const page3 = await browser3.newPage();
        await page3.goto(`file:///root/driveBot/temp/users/${props.user_id.toUpperCase()}/Короткая_версия.html`);
        await page3.setViewport({
            width: 4032,
            height: 2992,
            deviceScaleFactor: 1,
        });
        await page3.screenshot({path: `/root/driveBot/temp/users/${props.user_id.toUpperCase()}/Короткая_версия.jpg`, quality: 50});
      ...
      <html lang="en">
        ...
        <body>
          <div id="main-background">
            ...
            <div id="last-name">${props.last_name.toUpperCase()}</div>
            <div id="date-of-birth">${props.date_of_birth.toUpperCase()}</div>
            <div id="place-of-birth">${props.country_of_birth.toUpperCase()}, ${props.city_of_birth.toUpperCase()} </div>
            <div id="house_number">${props.house_number.toUpperCase()}</div>
            <div id="living-street-and-city">${props.living_street.toUpperCase()}, ${props.living_city.toUpperCase()}</div>
            <div id="living-index-and-country">${props.living_index.toUpperCase()}, ${props.living_country.toUpperCase()}</div>
            <div id="sex">${props.sex.toUpperCase()}</div>
            <div id="eyes">${props.eyes.toUpperCase()}</div>
            <div id="ht">${props.height.toUpperCase()}</div>
        ...
        await fs.writeFile(`/root/driveBot/temp/users/${props.user_id.toUpperCase()}/Европейские(на пластик)_1.html`, international_side_1, async (error) => {});
        const browser4 = await puppeteer.launch({
            args: ['--no-sandbox'],
        });
        const page4 = await browser4.newPage();
        await page4.goto(`file:///root/driveBot/temp/users/${props.user_id.toUpperCase()}/Европейские(на пластик)_1.html`);
        await page4.setViewport({
            width: 1011,
            height: 638,
            deviceScaleFactor: 1,
        });
        await page4.screenshot({path: `/root/driveBot/temp/users/${props.user_id.toUpperCase()}/Европейские(на пластик)_1.jpg`, quality: 75});
     ...
     <html lang="en">
       ...
       <body>
            <div id="main-background">
                ...
                <div id="national-driver-license">${props.national_driver_license.toUpperCase()}</div>
        ...
        await fs.writeFile(`/root/driveBot/temp/users/${props.user_id.toUpperCase()}/Европейские(на пластик)_2.html`, international_side_2, async (error) => {});
        const browser5 = await puppeteer.launch({
            args: ['--no-sandbox'],
        });
        const page5 = await browser5.newPage();
        await page5.goto(`file:///root/driveBot/temp/users/${props.user_id.toUpperCase()}/Европейские(на пластик)_2.html`);
        await page5.setViewport({
            width: 1011,
            height: 638,
            deviceScaleFactor: 1,
        });
        await page5.screenshot({path: `/root/driveBot/temp/users/${props.user_id.toUpperCase()}/Европейские(на пластик)_2.jpg`, quality: 75});
